...
/*Table structure for table `richkem_ad` */

DROP TABLE IF EXISTS `richkem_ad`;

CREATE TABLE `richkem_ad` (
...
/*Data for the table `richkem_ad` */

/*Table structure for table `richkem_asset` */

DROP TABLE IF EXISTS `richkem_asset`;

CREATE TABLE `richkem_asset` (
...
/*Data for the table `richkem_asset` */

/*Table structure for table `richkem_auth_access` */

DROP TABLE IF EXISTS `richkem_auth_access`;

CREATE TABLE `richkem_auth_access` (
...
/*Data for the table `richkem_auth_access` */

/*Table structure for table `richkem_auth_rule` */

DROP TABLE IF EXISTS `richkem_auth_rule`;

CREATE TABLE `richkem_auth_rule` (
...
/*Data for the table `richkem_comments` */

/*Table structure for table `richkem_common_action_log` */

DROP TABLE IF EXISTS `richkem_common_action_log`;

CREATE TABLE `richkem_common_action_log` (
...
/*Data for the table `richkem_common_action_log` */

/*Table structure for table `richkem_guestbook` */

DROP TABLE IF EXISTS `richkem_guestbook`;

CREATE TABLE `richkem_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `richkem_guestbook` */

/*Table structure for table `richkem_links` */

DROP TABLE IF EXISTS `richkem_links`;

CREATE TABLE `richkem_links` (
...
/*Data for the table `richkem_links` */

insert  into `richkem_links`(`link_id`,`link_url`,`link_name`,`link_image`,`link_target`,`link_description`,`link_status`,`link_rating`,`link_rel`,`listorder`) values (1,'http://www.thinkcmf.com','ThinkCMF','','_blank','',1,0,'',0);

/*Table structure for table `richkem_menu` */

DROP TABLE IF EXISTS `richkem_menu`;

CREATE TABLE `richkem_menu` (
...
/*Data for the table `richkem_nav` */

insert  into `richkem_nav`(`id`,`cid`,`parentid`,`label`,`target`,`href`,`icon`,`status`,`listorder`,`path`) values (1,1,0,'首页','','home','',1,0,'0-1'),(2,1,0,'列表演示','','a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"1\";}}','',1,0,'0-2'),(3,1,0,'瀑布流','','a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"2\";}}','',1,0,'0-3');

/*Table structure for table `richkem_nav_cat` */

DROP TABLE IF EXISTS `richkem_nav_cat`;

CREATE TABLE `richkem_nav_cat` (
...
/*Data for the table `richkem_nav_cat` */

insert  into `richkem_nav_cat`(`navcid`,`name`,`active`,`remark`) values (1,'主导航',1,'主导航');

/*Table structure for table `richkem_oauth_user` */

DROP TABLE IF EXISTS `richkem_oauth_user`;

CREATE TABLE `richkem_oauth_user` (
...
/*Data for the table `richkem_oauth_user` */

/*Table structure for table `richkem_options` */

DROP TABLE IF EXISTS `richkem_options`;

CREATE TABLE `richkem_options` (
...
/*Data for the table `richkem_plugins` */
